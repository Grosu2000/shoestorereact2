      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex mb-8" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-4">
            <li>
              <Link to="/" className="text-gray-400 hover:text-gray-500">Головна</Link>
            </li>
            <li>
              <span className="text-gray-400">/</span>
            </li>
            <li>
              <Link to="/products" className="text-gray-400 hover:text-gray-500">Товари</Link>
            </li>
            <li>
              <span className="text-gray-400">/</span>
            </li>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-3xl font-bold text-gray-900">{product.price} грн</div>
              {product.originalPrice && (
                <div className="text-xl text-gray-500 line-through">{product.originalPrice} грн</div>
              )}
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-gray-600">({product.reviewCount} відгуків)</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-sm text-gray-500">Залишилось: {product.stockQuantity} шт.</span>
                </div>
              </div>
            </div>
